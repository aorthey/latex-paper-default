...
\newcommand\se{ \ensuremath{\mathfrak{se}}\xspace}

%\newcommand\H{ \ensuremath{\mathbf{H}} }
\newcommand\e{\ensuremath{\mathbf{e}}\xspace}
\newcommand\force{\ensuremath{\mathbf{W}}\xspace}

\newcommand\dtau{\ensuremath{\dot{\tau}}\xspace}
\newcommand\dtaunorm{\dfrac{\dtau(s)}{\|\dtau(s)\|}}
\newcommand\ddtau{\ensuremath{\ddot{\tau}}\xspace}
\newcommand\ddtaumax{\ensuremath{\ddot{\tau}_{\text{max}}}\xspace}
...
\newcommand\ddti{\ensuremath{\dfrac{2}{\Delta t^2}}\xspace}
\newcommand\ds{\ensuremath{\Delta s}\xspace}
\newcommand\dds{\ensuremath{\dfrac{\Delta s^2}{2}}\xspace}

\newcommand\traj{\mathbf{q}}
\newcommand\q{\ensuremath{\traj}\xspace}
\newcommand\dq{\ensuremath{\dot{\traj}}\xspace}
\newcommand\ddq{\ensuremath{\ddot{\traj}}\xspace}

\newcommand\FF{{\it{FF}}\xspace}
\def\Fqq{\ensuremath{\mathcal{F}(q_I,q_G)}\xspace}
\newcommand\I{\ensuremath{\mathcal{I}}}
\def\Iqq{\ensuremath{\I(q_I,q_G)}\xspace}
\def\Eqq{\ensuremath{\mathcal{R}(q_I,q_G)}\xspace}
\def\FSF{\F_{S_F}}
\def\FS{\F_{S}}
...
\def\speedmax{\ensuremath{\theta_{\text{max}}}\xspace}
...
\def\C{\ensuremath{\mathcal{M}}\xspace}
\def\tangent{T}
\def\T{\tangent}
\def\TC{\ensuremath{\T\mathcal{M}}\xspace}
\def\flow{\ensuremath{\phi}\xspace}
...
\def\J{\ensuremath{\mathbf{J}}\xspace}
\def\L{\ensuremath{\mathbf{L}}\xspace}
\def\M{\ensuremath{\mathbf{M}}\xspace}
\def\A{\ensuremath{\mathbf{A}}\xspace}
\def\G{\ensuremath{\mathbf{G}}\xspace}
\def\H{\ensuremath{\mathbf{H}}\xspace}
\def\Reach{\ensuremath{R}\xspace}

\def\Line{\ensuremath{\mathcal{L}}\xspace}
